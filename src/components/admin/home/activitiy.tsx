    ...
    <>
      <header>
        ...
        <div className="flex flex-col items-start justify-between gap-x-8 gap-y-4 bg-slate-600 px-4 py-4 sm:flex-row sm:items-center sm:px-6 lg:px-8">
          ...
          <div className="order-first flex-none rounded-full bg-indigo-400/10 px-2 py-1 text-xs font-medium text-slate-400 ring-1 ring-inset ring-slate-400/30 sm:order-none">
            Production
          </div>
        </div>
      ...
      <div className="border-t border-white/10 pt-11">
        <h2 className="px-4 text-base font-semibold leading-7 text-slate-900 sm:px-6 lg:px-8">
          Latest activity
        </h2>
        <table className="mt-6 w-full whitespace-nowrap text-left">
          ...
          <thead className="border-b border-white/10 text-sm leading-6 text-slate-900">
            <tr>
              <th
                scope="col"
